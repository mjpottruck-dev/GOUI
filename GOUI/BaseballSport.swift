...
struct BaseballSport: SportDefinition {
    let id = SportCatalog.baseballID
    let displayName = "Baseball"
...
private let _baseballSportRegistration = SportCatalog.register(BaseballSport())
